...
jdkurl="http://download.oracle.com/otn-pub/java/jdk/8u144-b01/090f390dda5b47b9b721c7dfaa008135/"
jdkver="jdk1.8.0_144"
# ARM 32
if [ "$arch" = "armv7l" ]; then
	jdkarchive="jdk-8u144-linux-arm32-vfp-hflt.tar.gz"
# ARM 64
elif [ "$arch" = "aarch64" ]; then
	jdkarchive="jdk-8u144-linux-arm64-vfp-hflt.tar.gz"
# X86
elif [ "$arch" = "i586" ] || [ "$arch" = "i686" ]; then
	jdkarchive="jdk-8u144-linux-i586.tar.gz"
# X86_64	
elif [ "$arch" = "x86_64" ]; then
	jdkarchive="jdk-8u144-linux-x64.tar.gz"
fi
